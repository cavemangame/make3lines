	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		static void Main() 
		{
			Application.Run(new Form1());
				...
				Assert.AreEqual(
					...
					BuildStringFromLines(lines, 0, 10, 2, 12, NEW_LINE));
					...
					@"static void Main() 
		{
			Application.Run(new Form1());
					...
					BuildStringFromLines(lines, 10, 2, 13, 3, NEW_LINE));
				...
				Assert.AreEqual(lines.Length,
					SplitMultilineText(BuildStringFromLines(lines, NEW_LINE)).Length);
