...
namespace XnaTetris
{
	class BlocksGrid : DrawableGameComponent
	{
		...
		public readonly LinesGame game = null;
		...
		public void Restart()
		{
			...
			finder.FindAndDestroyLines(new GameTime());
		...
		{
			Grid[x, y] = (BlockFactory.GetBlockFactory(game).GetNewBlock(BlockFactory.GetNewBlockType(),
